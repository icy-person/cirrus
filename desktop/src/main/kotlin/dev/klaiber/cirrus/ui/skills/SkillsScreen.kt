...
fun SkillsScreen(
        ...
        LazyColumn(
            ...
            item(key = "intro") {
                Text(
                    ...
                    modifier = Modifier.readingMeasure().padding(bottom = 6.dp),
                )
            }
                ...
                OutlinedPanel(shape = LargeContainerShape, modifier = Modifier.readingMeasure()) {
                    Row(
                        ...
                        Switch(
                            ...
                            onCheckedChange = model::setSkillsEnabled,
                        )
                    }
                }
            }
            ...
            if (state.skills.isEmpty()) {
                ...
                items(state.skills, key = { it.id }) { skill ->
                    InstalledSkillCard(
                        ...
                        onToggle = { model.setEnabled(skill.id, it) },
    ...
    removeTarget?.let { target ->
        AlertDialog(
            ...
            text = {
                Text(
                    "Its instructions are deleted from this computer. It stays in the library, so " +
